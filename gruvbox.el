...
(defmacro gruvbox-deftheme (name description palette &rest body)
  ...
  `(autothemer-deftheme
    ...
    ((cursor              (:background gruvbox-light0))
     ...
     (hl-line             (:background gruvbox-faded_purple :extend t))
     ...
     (region              (:background gruvbox-faded_purple :extend t))
     ...
     ;; selectrum
     (selectrum-current-candidate (:background gruvbox-faded_green :foreground gruvbox-light0 :weight 'bold))
