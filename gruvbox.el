...
(defmacro gruvbox-deftheme (name description palette &rest body)
  `(autothemer-deftheme
    ...
    ((default                                   (:background gruvbox-bg :foreground gruvbox-light0))
     ...
     (diredp-compressed-file-suffix             (:foreground gruvbox-faded_aqua ))
     (diredp-dir-name                           (:foreground gruvbox-faded_aqua ))
     ...
     (diredp-number                             (:foreground gruvbox-faded_aqua ))
     ...
     (diredp-dir-priv                           (:foreground gruvbox-faded_aqua  :background gruvbox-dark_blue))
     (diredp-exec-priv                          (:foreground gruvbox-faded_aqua  :background gruvbox-dark_blue))
