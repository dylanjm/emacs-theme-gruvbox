...
(defmacro gruvbox-deftheme (name description palette &rest body)
  `(autothemer-deftheme
    ...
    ((default                                   (:background gruvbox-bg :foreground gruvbox-light0))
     ...
     (region                                    (:background gruvbox-dark2 :extend t)) ;;selection
     (secondary-selection                       (:background gruvbox-dark1 :extend t))
     (minibuffer-prompt                         (:background gruvbox-dark0_soft :foreground gruvbox-bright_green :bold t))
     ...
     (diredp-compressed-file-suffix             (:foreground gruvbox-faded_cyan ))
     (diredp-dir-name                           (:foreground gruvbox-faded_cyan ))
     (diredp-dir-heading                        (:foreground gruvbox-bright_cyan ))
     (diredp-symlink                            (:foreground gruvbox-bright_orange ))
     (diredp-date-time                          (:foreground gruvbox-light3 ))
     (diredp-number                             (:foreground gruvbox-faded_cyan ))
     ...
     (diredp-dir-priv                           (:foreground gruvbox-faded_cyan  :background gruvbox-dark_blue))
     (diredp-exec-priv                          (:foreground gruvbox-faded_cyan  :background gruvbox-dark_blue))
     (diredp-link-priv                          (:foreground gruvbox-faded_aqua  :background gruvbox-dark_yellow))
     (diredp-read-priv                          (:foreground gruvbox-bright_red  :background gruvbox-dark_red))
     (diredp-write-priv                         (:foreground gruvbox-bright_aqua :background gruvbox-dark_yellow))
     ...
     (org-block                                 (:background gruvbox-dark0_soft :extend t))
     (org-block-begin-line                      (:background gruvbox-dark1 :extend t))
