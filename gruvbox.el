...
(defmacro gruvbox-deftheme (name description palette &rest body)
  ...
  `(autothemer-deftheme
    ...
    ((cursor              (:background gruvbox-light0))
     ...
     (mode-line           (:inherit 'variable-pitch :background gruvbox-dark0 :foreground gruvbox-light3 :box (:line-width 8 :color gruvbox-dark0) :overline nil :underline t))
     (mode-line-inactive  (:inherit 'variable-pitch :background gruvbox-dark0_hard :foreground gruvbox-light1 :box (:line-width 8 :color gruvbox-dark0_hard) :overline nil :underline t))
