...
(defmacro gruvbox-deftheme (name description palette &rest body)
  `(autothemer-deftheme
    ...
    ((default                                   (:background gruvbox-bg :foreground gruvbox-light1))
     ...
     (org-block-begin-line                      (:underline gruvbox-light4 :background gruvbox-dark0 :foreground gruvbox-dark4))
     (org-block-end-line                        (:overline gruvbox-light4 :background gruvbox-dark0 :foreground gruvbox-dark4))
