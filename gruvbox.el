...
(defmacro gruvbox-deftheme (name description palette &rest body)
  `(autothemer-deftheme
    ...
    ((default                                   (:background gruvbox-bg :foreground gruvbox-light1))
     ...
     (mode-line                                 (:background gruvbox-dark0_hard :foreground gruvbox-light2 :box nil))
     (mode-line-inactive                        (:background gruvbox-dark0_hard :foreground gruvbox-light2 :box nil))
     ...
     ;; line numbers
     (line-number                               (:foreground gruvbox-dark4 :background gruvbox-dark0_hard))
     ...
     (diredfl-deletion               (:foreground gruvbox-dark0_hard :background gruvbox-dark_red))
     (diredfl-deletion-file-name     (:foreground gruvbox-dark0_hard :background gruvbox-dark_red))
     ...
     (diredfl-flag-mark             (:foreground gruvbox-bright_yellow :background gruvbox-faded_yellow :weight 'bold))
     (diredfl-flag-mark-line        (:background gruvbox-bright_orange))
     ...
     (diredfl-write-priv            (:foreground gruvbox-dark_red))
     ...
     (org-block                                 (:background gruvbox-dark0 :extend t))
     (org-block-begin-line                      (:background gruvbox-dark0 :extend t))
     (org-block-end-line                        (:background gruvbox-dark0 :extend t))
     ...
     ;; ivy
     (ivy-current-match                         (:foreground gruvbox-light4 :weight 'bold :underline t))
     ...
     (ivy-minibuffer-match-highlight            (:foreground gruvbox-dark0 :background gruvbox-dark2))
