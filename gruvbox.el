...
(defmacro gruvbox-deftheme (name description palette &rest body)
  ...
  `(autothemer-deftheme
    ...
    ((cursor              (:background gruvbox-light0))
     ...
     ;; smart-mode-line
     (sml/modes                                 (:foreground gruvbox-light0 :weight 'bold :bold t))
     (sml/minor-modes                           (:foreground gruvbox-light4 :italic t))
     ...
     (sml/read-only                             (:foreground gruvbox-faded_red))
     (sml/outside-modified                      (:foreground gruvbox-bright_yellow))
     (sml/modified                              (:foreground gruvbox-bright_purple))
     ...
     (sml/col-number                            (:foreground gruvbox-bright_orange))
     (sml/position-percentage                   (:foreground gruvbox-faded_aqua))
