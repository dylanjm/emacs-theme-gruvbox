...
(defmacro gruvbox-deftheme (name description palette &rest body)
  ...
  `(autothemer-deftheme
    ...
    ((cursor              (:background gruvbox-light0))
     ...
     (mode-line           (:background gruvbox-dark0_hard :foreground gruvbox-light2 :box '(:line-width 8 :color gruvbox-dark4) :overline nil :underline nil))
     (mode-line-inactive  (:background gruvbox-dark0_hard :foreground gruvbox-dark4 :box '(:line-width 8 :color gruvbox-dark4) :overline nil :underline nil))
